...
public class GameManager : MonoBehaviour
{
    ...
    {
        GUI.skin = layout;
        GUI.Label(new Rect(Screen.width / 2 - 500 - 12, 250, 100, 100), "" + PlayerScore1);
        GUI.Label(new Rect(Screen.width / 2 + 500 + 12, 250, 100, 100), "" + PlayerScore2);

        if (GUI.Button(new Rect(15, 35, 120, 53), "RESTART"))
        {
            PlayerScore1 = 0;
            PlayerScore2 = 0;
